...
There are three files that become part of the provisioning webpage. After gzip and minification, they consume **21k** of filesystem flash space. There is no reloading of this webpage after it is first loaded. All updates and changes in appearance are managed directly by the JavaScript. This includes connection success and fail notifications, and return to scanning operation after a failed connection attempt.
